...
async function _generaDocxRiunione(verbale) {
    ...
    doc.setData({
        ...
        modulo_codice:     settings.modulo_codice   || '',
        modulo_versione:   settings.modulo_versione || '',
        ss_numero:         project?.ssNumero              || '',
        codice_ppm_sil:    project?.codicePpmSil          || '',
        titolo_lavoro:     project?.nome                  || '',
        ...
        struttura_territoriale: project?.strutturaTerritoriale || '',
        committente:       project?.committente            || '',
        cup:               project?.cup                   || '',
        cig:               project?.cig                   || '',
