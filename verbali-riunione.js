...
async function salvaRiunione(event) {
  ...
  const riunione = {
    ...
    firmante:        (function(i){ return i.riuTecnicoNome || i.firmaNome || 'Coordinatore per l\'Esecuzione'; })(await caricaImpostazioni().catch(()=>({}))),
      ...
      <table style="width:100%; border-collapse:collapse; margin-top:8mm; border-top:1pt solid #cbd5e1; padding-top:4mm;">
        <tr>
          <td style="width:50%; border:none; padding:0 8mm 0 0; text-align:left; vertical-align:bottom;">
            ...
            <div style="font-size:9pt; font-weight:700; color:#0f172a;">${escapeHtml(imp.riuTecnicoNome || imp.firmaNome || 'Coordinatore per l\'Esecuzione')}</div>
            <div style="font-size:8pt; color:#64748b;">${escapeHtml(imp.riuTecnicoQualifica || imp.firmaQualifica || 'Coordinatore Sicurezza (CSE)')}</div>
          </td>
